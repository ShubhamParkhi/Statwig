...
const SupplyChainHeroContainer: NextPage = () => {
  return (
    <div className="self-stretch flex flex-col items-center justify-center py-[75px] px-[30px] text-left text-lg text-black font-inter">
      <div className="w-full flex flex-row items-center justify-between max-w-[1065px] sm:flex-col sm:gap-[15px] sm:items-center sm:justify-center">
        <div className="flex-1 flex flex-col items-start justify-center gap-[35px] sm:flex-[unset] sm:self-stretch">
        ...
        <Image
          className="flex-1 max-w-full overflow-hidden h-[454px] object-contain sm:flex-[unset] sm:self-stretch"
          alt=""
          src="/frame-6@2x.png"
          priority
          width={1065}
